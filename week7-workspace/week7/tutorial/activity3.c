...
int main(void) {
    ...
    if (has_duplicates(unique_nums, size)) {
        printf("unique_nums contains duplicates\n");
    } else {
        printf("unique_nums does not contain duplicates\n");
    }

    if (has_duplicates(duplicate_nums, duplicate_size)) {
        printf("duplicate_nums contains duplicates\n");
    } else {
        printf("duplicate_nums does not contain duplicates\n");
    }
}
