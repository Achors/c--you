...
//funtion prototype (it calls the function readnumber that stores a number when given and checks if it satisfies the cindition given then returns a value)
//it takes the params min and max that are basically the smallest number and the largest number given in the range
